...
cc-bridge-slack/
├── README.md                           ← this file
├── INSTALL.md                          ← new-machine bootstrap guide
...
│   └── launchd/com.bear.cc-bridge.plist ← LaunchAgent definition
├── docs/phase-1.5-devlog.md            ← historical record
...
| Stop daemon | `launchctl bootout gui/$(id -u)/com.bear.cc-bridge` |
| Restart daemon | `launchctl kickstart -k gui/$(id -u)/com.bear.cc-bridge` |
